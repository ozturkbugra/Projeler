...
namespace muhasebe
{
    public partial class OdemeTuru : Form
    {
        ...
        {
            dgvSektor.DataSource = b.veriAl("Select * from tblOdemeTuru");
        ...
        private void btnEkle_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string sorgu = "Select count(*) from tblOdemeTuru where OdemeAd=@p1";
            ...
            {
                conn.Open();
                string sql = "Insert Into tblOdemeTuru (OdemeAd) values (@p1)";
            ...
            {
                MessageBox.Show("Bu ödeme türü sisteme kayıtlı");
            }
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string sql = "Update tblOdemeTuru set OdemeAd=@p1 where OdemeId=@p2";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@p1", txtAd.Text);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                string sql = "Select count(*) from TblGiderler where OdemeTuru=@p2";
                SqlCommand cmd = new SqlCommand(sql, conn);
                cmd.Parameters.AddWithValue("@p2", dgvSektor.CurrentRow.Cells[0].Value.ToString());
                ...
                {
                    conn.Open();
                    string sql2 = "Delete from tblOdemeTuru where OdemeId=@p2";
                ...
                {
                    MessageBox.Show("Bu ödeme türü ile gider yaptığınız için silinemiyor");
                    conn.Close();
                }
            }
        }
